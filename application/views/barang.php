  ...
  <body>
    ...
    <div class="container-fluid">
    	<div class="col-md-7 col-md-offset-2">
    		<form class="form-horizontal" method="post" action="<?=site_url('barang/simpan')?>">
        ...
        <div class="col-md-7 col-md-offset-2">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                    <?php
                        foreach ($DaftarBarang as $val) {
                    ?>
                        <td> <?php //echo $key+1 ?> </td>
                        <td> <?php echo $val->nama_barang ?> </td>

                        <td>
                            <a href="barang_form_edit.php?id=<?php echo $val->id_barang; ?>">
                        ...
                        <td>
                            <a href="barang_delete.php?id=<?php echo $val->id_barang; ?>">
